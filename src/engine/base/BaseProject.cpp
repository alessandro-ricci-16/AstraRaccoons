...
void BaseProject::framebufferResizeCallback(GLFWwindow* window,
...
void BaseProject::createInstance() {
    ...
    appInfo.pEngineName = "Raccoongine";
...
bool BaseProject::checkIfItHasDeviceExtension(VkPhysicalDevice device,
                                              const char* ext) {
...
void BaseProject::pickPhysicalDevice() {
    ...
    for (const auto& device : devices) {
        ...
        if (suitable) {
            ...
            std::cout << "\n\nMaximum samples for anti-aliasing: "
                      << msaaSamples << "\n\n\n";
            break;
        } else {
...
bool BaseProject::isDeviceSuitable(VkPhysicalDevice device,
                                   deviceReport& devRep) {
...
bool BaseProject::checkDeviceExtensionSupport(VkPhysicalDevice device,
                                              deviceReport& devRep) {
    uint32_t extensionCount;
    vkEnumerateDeviceExtensionProperties(device, nullptr, &extensionCount,
                                         nullptr);
...
SwapChainSupportDetails BaseProject::querySwapChainSupport(
...
VkExtent2D BaseProject::chooseSwapExtent(
...
VkFormat BaseProject::findSupportedFormat(
...
void BaseProject::copyBufferToImage(VkBuffer buffer, VkImage image,
...
void BaseProject::RebuildPipeline() { framebufferResized = true; }

// Control Wrapper
void BaseProject::handleGamePad(int id, glm::vec3& m, glm::vec3& r,
                                bool& fire) {
...
void BaseProject::getSixAxis(float& deltaT, glm::vec3& m, glm::vec3& r,
                             bool& fire) {
